...
variables for the cc370 toolchain build.  Called once by mk/v2.mk at
make startup (via $(shell)).

Usage:
    python3 mbtconfig_v2.py [--project project.toml]
...
def generate(project_file: str = "project.toml", builddir: str = "build") -> str:
    ...
    lines = [
        "# Auto-generated by mbtconfig_v2.py -- do not edit",
